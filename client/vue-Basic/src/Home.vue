...
<template>
	<div class="pagina">
		...
		<!-- Boas-vindas -->
		<div class="bem-vindo">
			Bem Vindo ao <span class="destaque">BibSys</span> !!
		</div>
		...
		<div class="container2">
			<img
				...
				style="left: 896px; top: 371px"
			/>
			<img
				class="capa-livro"
				src="https://images-na.ssl-images-amazon.com/images/I/71HMyqG6MRL.jpg"
				style="left: 911px; top: 386px"
			/>
			<img
				class="capa-livro"
				src="https://i.pinimg.com/originals/97/5e/a2/975ea2ac189028a6d7feac374ae36181.jpg"
				style="left: 930px; top: 406px"
			/>
			<img
				class="capa-livro"
				src="https://images-na.ssl-images-amazon.com/images/I/91HHqVTAJQL.jpg"
				style="left: 948px; top: 422px"
			/>
			<img
				class="capa-livro"
				src="https://images-na.ssl-images-amazon.com/images/I/81OthjkJBuL.jpg"
				style="left: 963px; top: 437px"
			/>
		</div>

		<!-- Botões de ação -->
		<div class="botao botao-cadastrar" @click="irParaCadastrar">
			Cadastrar livro
		</div>
