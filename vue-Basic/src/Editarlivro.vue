  ...
  <div class="tela-cadastro">
   ...
   <div class="svg-container2" aria-hidden="true">
    ...
    <div class="caixa-principal">
      ...
      <!-- Botão cadastrar -->
      <div class="botao-cadastrar">Editar livro</div>
      ...
      <div class="descricao-formulario">
        <span class="highlight">Edite</span>
        <span>  apenas o campo </span>
        <span class="highlight"> desejado</span>
        <span>  e, em seguida, clique em </span>
        <span class="highlight"> Editar Livro</span>
        <span>.</span>
      </div>
...
.label.ano { left: 110px; top: 516px; }
